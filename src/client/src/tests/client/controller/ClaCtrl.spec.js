...
describe('LICENSE Controller', function () {
    ...
    it('should get LICENSE text and updated date', function () {
        user.value = {};
        user.meta = {};
        claSigned = false;
    ...
    it('should get LICENSE text with meta data', function () {
    ...
    it('should get LICENSE text with orgid', function () {
        user.value = {};
        user.meta = {};
        claSigned = false;
        linkedItem = { orgId: 2 };
    ...
    it('should not check LICENSE if user not logged', function () {
        var claCheckWasCalled = false;
        _HUBService.call.restore();
        sinon.stub(_HUBService, 'call', function (o, functn, data, cb) {
            var deferred = _q.defer();
    ...
    it('should check whether user has signed LICENSE already or not and redirect if redirect param set to true', function () {
    ...
    it('should check whether user has signed LICENSE already or NOT', function () {
        claSigned = false;
        claController = createCtrl();
