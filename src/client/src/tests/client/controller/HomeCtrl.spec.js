...
describe('Home Controller', function () {
    ...
    it('should identify default gist url from all gists', function () {
        ...
        (homeCtrl.scope.groupDefaultCla(sapClaGist)).should.be.equal('Default LICENSEs');

        var anyOtherGist = {
            name: 'any name',
            url: 'https://gist.github.com/gitID'
        };
        (homeCtrl.scope.groupDefaultCla(anyOtherGist)).should.not.be.equal('Default LICENSEs');
    });
