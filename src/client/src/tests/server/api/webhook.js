...
describe('webhookApi', function () {
    ...
    describe('webhook:create', () => {
        ...
        it('should NOT remove a webhook for a repo with NULL LICENSE after creating an org webhook', async () => {
            repo.gist = null
            let expArgs = {
                obj: 'repos',
                fun: 'deleteWebhook',
    ...
    describe('webhook:remove', function () {
        ...
        it('should NOT create hook for repo with NULL LICENSE after removing org hook', async () => {
            resGetRepoHooks = []
            repo.gist = null
            let expArgs = {
                obj: 'repos',
