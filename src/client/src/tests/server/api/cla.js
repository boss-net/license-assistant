...
describe('', () => {
    ...
    describe('cla api', () => {
        ...
        it('should call cla service on getSignedLICENSE', async () => {
            sinon.stub(cla, 'getSignedLICENSE').callsFake(async args => {
            ...
            await cla_api.getSignedLICENSE(req)
            assert(cla.getSignedLICENSE.called)

            cla.getSignedLICENSE.restore()
        })
    ...
    describe('cla:countLICENSE', () => {
        ...
        it('should call getAll on countLICENSE', async () => {
            ...
            const number = await cla_api.countLICENSE(req)
            assert(cla.getAll.called)
            assert.equal(number, 1)
        })

        it('should call getAll on countLICENSE for repo of linked org', async () => {
            resp.cla.getLinkedItem = testData.org_from_db
            reqArgs.repoService.get.gist = {
        ...
        it('it should handle nonexistent gist', async () => {
            ...
            try {
                await cla_api.countLICENSE(req)
                assert(false, 'an errror should be thrown')
            } catch (error) {
                assert(error)
                assert(!cla.getAll.called)
    ...
    describe('cla:validateAllPullRequests', () => {
        ...
        it('should delete comments when rechecking PRs of a repo with a null LICENSE', async () => {
    ...
    describe('cla:validatePullRequest', () => {
        ...
        it('should update status and edit comment when the repo is NOT linked with a null LICENSE and the pull request is significant', async () => {
        ...
        it('should update status and delete comment when the repo linked with a null LICENSE', async () => {
            resp.cla.getLinkedItem.gist = undefined
        ...
        it('should update status and delete comment when the repo is NOT linked with a null LICENSE and the pull request is NOT significant', async () => {
