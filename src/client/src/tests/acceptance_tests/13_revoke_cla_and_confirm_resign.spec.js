...
let testLICENSEUser = process.env.TEST_LICENSE_USER


Feature(`Revoke and Resign LICENSE`)
...
Scenario(`revoke cla for repo1`, (I) => {
    session('contributor', () => {
        ...
        I.wait(3)
        cla.revokeLICENSE(I, testUserName, `repo1`)
    })
})

Scenario('create PR and resign LICENSE', (I) => {
    session('contributor', () => {
        github.login(I, testContributorName, testContributorPass)
        ...
        I.see('Pending')
        I.waitForVisible('//h3[contains(@class, "timeline-comment-header-text") and contains(., "' + testLICENSEUser + '")]', 10)
        ...
        I.see('All committers have signed the LICENSE')
    })
})
