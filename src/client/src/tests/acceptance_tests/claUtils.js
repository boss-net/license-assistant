...
module.exports = {
    linkRepo: function (I, owner, repo) {
        ...
        I.refreshPage()
        I.wait(5)
        I.waitForVisible('//button[contains(., "Configure LICENSE")]', 5)
        I.waitForInvisible('.loading-indicator', 5)
        I.click('//button[contains(., "Configure LICENSE")]')
        I.wait(1)
    ...
    revokeLICENSE: function (I, owner, repo) {
        I.see('View my signed LICENSEs')
        I.click('View my signed LICENSEs')
        I.wait(5)
        I.see(`${owner} / ${repo}`)
